...
const DJ_BREAKS = {
  ...
  // ============================================
  stationids: [
    "96.6 ROM, Victoria BC.",
    "You're listening to 96.6 ROM, dedicated to Pauline.",
    "This is 96.6 ROM, playing the hits.",
    "96.6 ROM, Victoria's station for love.",
    "You're tuned into 96.6 ROM.",
    "This is 96.6 ROM, broadcasting live from Victoria.",
    "96.6 ROM, where every song is for Pauline.",
    "You're locked in to 96.6 ROM.",
    "This is 96.6 ROM, Victoria's warmest frequency.",
    "96.6 ROM, playing the hits dedicated to you.",
    "You're listening to 96.6 ROM, stay tuned.",
    "This is 96.6 ROM, broadcasting live from Daniel's heart.",
    "96.6 ROM, Victoria BC, playing non-stop music.",
    "You're on 96.6 ROM, the station built for Pauline.",
    "This is 96.6 ROM, more music coming right up.",
    "96.6 ROM, Victoria's most romantic station.",
    "You're tuned into 96.6 ROM, stay with us.",
    "This is 96.6 ROM, live from Victoria.",
    "96.6 ROM, the only station that matters.",
    "You're listening to 96.6 ROM, good music only.",
    "This is 96.6 ROM, Pauline's station.",
    "96.6 ROM, broadcasting love since day one.",
    "You're on 96.6 ROM, Victoria's finest.",
    "This is 96.6 ROM, keep it locked.",
    "96.6 ROM, where the music never stops.",
    "You're tuned in to 96.6 ROM, more hits ahead.",
    "This is 96.6 ROM, Victoria's number one.",
    "96.6 ROM, dedicated entirely to Pauline.",
    "You're listening to 96.6 ROM, stay right here.",
    "This is 96.6 ROM, your soundtrack.",
    "96.6 ROM, live and direct from Victoria.",
    "You're on 96.6 ROM, don't touch that dial.",
    "This is 96.6 ROM, coming at you live.",
    "96.6 ROM, the station powered by love.",
    "You're locked into 96.6 ROM, Victoria BC.",
  ],
